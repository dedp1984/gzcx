      ...
      function ($stateProvider,   $urlRouterProvider) {
          $stateProvider
              ...
              .state('app.sysaccounts.list',{
                  url:'/list',
                  templateUrl:'app/system/tpl/sysaccount-list.html',
              ...
              .state('app.sysaccounts.add',{
                  url:'/add',
                  templateUrl:'app/system/tpl/sysaccount-add.html',
              ...
              .state('app.sysaccounts.detail',{
                  url:'/detail',
                  templateUrl:'app/system/tpl/sysaccount-detail.html',
                  controller:function($scope,toaster,CarCreditRestangular){
              ...
              .state('app.sysbranchs.add',{
                  url:'/add',
                  templateUrl:'app/system/tpl/sysbranch-add.html'
              })
              //经销商管理-编辑经销商
              .state('app.sysbranchs.detail',{
                  url:'/detail/:id',
                  templateUrl:'app/system/tpl/sysbranch-detail.html'
              })
              //菜单管理
              .state('app.sysmenu',{
                  abstract:true,
              ...
              .state('app.sysmenu.list',{
                  url:'/list',
                  templateUrl:'app/system/tpl/sysmenu-list.html',
                  controller:function($scope){
                      $scope.getList();
                  }
              })
              .state('app.sysmenu.add',{
                  url:'/add',
                  templateUrl:'app/system/tpl/sysmenu-add.html'
              })
              .state('app.sysmenu.detail',{
                  url:'/detail',
                  templateUrl:'app/system/tpl/sysmenu-detail.html'
              })
              .state('app.sysrole',{
                  abstract:true,
                  url:'/sysrole',
              ...
              .state('app.sysrole.list',{
                  url:'/list',
                  templateUrl:'app/system/tpl/sysrole-list.html',
                  controller:function($scope){
                      $scope.getList();
                  }
              })
              .state('app.sysrole.add',{
                  url:'/add',
                  templateUrl:'app/system/tpl/sysrole-add.html'
              })
              .state('app.sysrole.detail',{
                  url:'/detail',
                  templateUrl:'app/system/tpl/sysrole-detail.html'
              })
              .state('app.sysrole.auth',{
                  url:'/auth',
                  templateUrl:'app/system/tpl/sysrole-auth.html'
              })
      }
    ]
  );